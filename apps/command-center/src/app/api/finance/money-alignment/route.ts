...
const allocationSnapshot: AllocationRow[] = [
  ...
  },
  {
    ...
    gateStatus: 'pause',
    workspace: 'Place',
    decision: 'Highest-risk place spend. Pause discretionary spend until lease, insurance, revenue bridge, break-even and stop-loss are explicit. (Includes former ACT-BV Black Cockatoo Valley — merged 2026-06-08, same Witta land.)',
  },
  {
    code: 'ACT-ER',
