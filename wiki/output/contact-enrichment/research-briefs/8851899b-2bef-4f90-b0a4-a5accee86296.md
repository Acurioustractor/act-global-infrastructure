...
# Contact research brief — Brodie Germaine Fitness Aboriginal Corporation
...
4. **Organisation's own website** — search Google for "Brodie Germaine Fitness Aboriginal Corporation" plus state. If there's no website, check Facebook / LinkedIn / local government listings.
