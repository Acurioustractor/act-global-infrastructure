...
# Contact research brief — Scotdesco Aboriginal Corporation

## What we know

- **Name:** Scotdesco Aboriginal Corporation
- **State:** SA
- **ABN:** 44335892243
...
4. **Organisation's own website** — search Google for "Scotdesco Aboriginal Corporation" plus state. If there's no website, check Facebook / LinkedIn / local government listings.
