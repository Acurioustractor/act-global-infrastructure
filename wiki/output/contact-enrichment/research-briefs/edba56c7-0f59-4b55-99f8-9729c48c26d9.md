---
gs_entity_id: edba56c7-0f59-4b55-99f8-9729c48c26d9
org_name: "Ngurratjuta/Pmara Ntjarra Aboriginal Corporation"
state: NT
abn: 79602462309
...
# Contact research brief — Ngurratjuta/Pmara Ntjarra Aboriginal Corporation

## What we know

- **Name:** Ngurratjuta/Pmara Ntjarra Aboriginal Corporation
- **State:** NT
- **ABN:** 79602462309
...
4. **Organisation's own website** — search Google for "Ngurratjuta/Pmara Ntjarra Aboriginal Corporation" plus state. If there's no website, check Facebook / LinkedIn / local government listings.
