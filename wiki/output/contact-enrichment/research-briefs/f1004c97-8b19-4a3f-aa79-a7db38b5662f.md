---
gs_entity_id: f1004c97-8b19-4a3f-aa79-a7db38b5662f
org_name: "Aboriginal & Torres Strait Islander Corporation for Disabled and Respite Care"
state: QLD
abn: 96594091338
...
# Contact research brief — Aboriginal & Torres Strait Islander Corporation for Disabled and Respite Care

## What we know

- **Name:** Aboriginal & Torres Strait Islander Corporation for Disabled and Respite Care
- **State:** QLD
- **ABN:** 96594091338
...
4. **Organisation's own website** — search Google for "Aboriginal & Torres Strait Islander Corporation for Disabled and Respite Care" plus state. If there's no website, check Facebook / LinkedIn / local government listings.
