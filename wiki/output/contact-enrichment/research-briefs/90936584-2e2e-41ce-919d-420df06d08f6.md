...
# Contact research brief — Kurdiji Aboriginal Corporation

## What we know

- **Name:** Kurdiji Aboriginal Corporation
- **State:** NT
- **ABN:** 32494962004
...
4. **Organisation's own website** — search Google for "Kurdiji Aboriginal Corporation" plus state. If there's no website, check Facebook / LinkedIn / local government listings.
