...
# Contact research brief — First Tasmanians Aboriginal Corporation (FTAC)

## What we know

- **Name:** First Tasmanians Aboriginal Corporation (FTAC)
- **State:** TAS
- **ABN:** 89371379452
...
4. **Organisation's own website** — search Google for "First Tasmanians Aboriginal Corporation (FTAC)" plus state. If there's no website, check Facebook / LinkedIn / local government listings.
