---
gs_entity_id: eb1ec908-8f31-40ce-8d5f-35e1fcc2479f
org_name: "Pitjantjatjara Yankunytjatjara Media (Aboriginal Corporation)"
state: NT
abn: 56496236911
entity_type: charity
...
# Contact research brief — Pitjantjatjara Yankunytjatjara Media (Aboriginal Corporation)

## What we know

- **Name:** Pitjantjatjara Yankunytjatjara Media (Aboriginal Corporation)
- **State:** NT
- **ABN:** 56496236911
- **Entity type:** charity
...
4. **Organisation's own website** — search Google for "Pitjantjatjara Yankunytjatjara Media (Aboriginal Corporation)" plus state. If there's no website, check Facebook / LinkedIn / local government listings.
