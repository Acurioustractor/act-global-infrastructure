...
cycle: [funder-pitch, term-sheet, sector-convening, always]
sources:
  - path: ../JusticeHub/output/goods-on-country/community-ownership-checkpoints.md
    section: "Community-Ownership Checkpoints — Month 6"
    quote: "Four checkpoints, signed off by community partner, reviewed at month 3 and month 6 from agreement date."
related_claims: [claim-not-charity-its-enterprise, claim-unit-economics-must-be-real]
backlinks_to_concepts: [ntumba, alice-springs, community-control, partial-counts-as-no]
---

# Claim: Community ownership is binary, dated, and signed
...
- → `claim-not-charity-its-enterprise` — the parent argument
- → `claim-unit-economics-must-be-real` — the financial test that runs alongside the ownership test
- → Cross-project: `contained:claim-this-is-not-charity-its-infrastructure`
