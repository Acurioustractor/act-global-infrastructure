...
- **consent violations — real live count 75, not 284** (the worksheet's 284 was stale/gone-from-ghl inflated). Split: 13 community-line (no consent) + 62 non-community (no consent); 204 consented (kept). **🟢 community-line 13 STRIPPED 2026-06-08** (`scripts/strip-noconsent-newsletter-community-2026-06-08.mjs`; 20 consented community-line kept — agency model). **🔴 62 non-community no-consent newsletter holders STILL OPEN** — a Spam-Act decision (strip vs investigate-whether-they-actually-opted-in), not OCAP; needs Ben's call.
