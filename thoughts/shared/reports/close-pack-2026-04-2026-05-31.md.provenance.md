---
title: "Close pack 2026-04 Provenance"
status: Generated
date: 2026-05-31
type: provenance
...
# Close pack 2026-04 — Provenance

## Purpose
- Output: period close pack (ready-to-close gate across 7 lenses)
- Intended destination: thoughts/shared/reports/close-pack-2026-04-2026-05-31.md → Standard Ledger handoff / Pty cutover prep
- Why generated: close-the-books assistant (#4 ongoing-bookkeeping roadmap)

## Data Sources Queried
| Source | Type | Range | How used |
|---|---|---|---|
| xero_invoices (ACCPAY) | app DB (NEXT_PUBLIC) | 2026-04-01–2026-04-30 | bills: receipts, tagging, GE-429, 1B GST, bills-raised |
| xero_invoices (ACCREC) | app DB | 2026-04-01–2026-04-30 | sales: income, 1A GST |
| xero_transactions | app DB | 2026-04-01–2026-04-30 | recon%, bank spend, tagging, R&D (rd_eligible) |
| detect-finance-anomalies.mjs --json | script | all-time, filtered to window | void/dup candidates (cleanliness lens) |
| .xero-sync-state.json | sync cursor | 2026-05-31T20:00:01.271Z | data-freshness stamp |
...
- `Unverified:` R&D bank-txn classification depends on tag-rd-eligibility.mjs having been applied to this DB (142 txns classified); bills carry no R&D flag.
...
## Reproduction Steps
1. `node scripts/close-the-books.mjs 2026-04` (human) or `--json` (machine)
2. `node scripts/close-the-books.mjs 2026-04 --save` regenerates this pack + sidecar
3. Cross-check: recon%/untagged vs `finance-daily-digest.mjs`; anomalies vs `detect-finance-anomalies.mjs`; BAS vs `prepare-bas.mjs `

## Linked Artifacts
- Output artifact: thoughts/shared/reports/close-pack-2026-04-2026-05-31.md
