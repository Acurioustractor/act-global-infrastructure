...
**RESUME MENU:** (1) **6 locked-period dups → Standard Ledger** ($3,221.03 prior-period adjustment) · (2) **pay Kirmos INV-004 $4,500** (confirmed owed, not a dup) · (3) Ben's **Webflow attach test** (proves live receipt upload — filter Receipt→"Bill · no receipt"→Webflow $29→attach) · (4) build **#4 close-the-books assistant** (BAS/R&D/monthly-close packs) · (5) wire **#2 digest** → Telegram/Notion + PM2 cron · surface **#3** in the mirror UI · **deploy** to command.act.place.
