...
**Do not open with "ACT is a regenerative innovation ecosystem."**
...
## The translation layer (rename table)

| What ACT currently says | What Minderoo understands | Why swap |
|---|---|---|
...
## The endurance-shaped deliverables

Minderoo CEO John Hartman's 2025 Impact Report opens with **"endurance and accountability."** Rewrite ALL deliverables to be endurance-shaped, not output-shaped.
...
## Flags for the relationship conversation (Ben → Lucy pre-envelope)

1. **What is Lucy's typical grant band for Youth Justice?** Ceiling and floor. $2.9M might be above her portfolio's typical envelope and need board-level sign-off.
2. **Can ACT be the grant recipient, holding infrastructure, and Minderoo accept that ACCO partners are sub-granted via the relationships (not directly)?** Or does Minderoo require direct-to-ACCO?
3. **Does Lucy prefer the envelope before or after she's had a chance to pitch it internally?** A 1 May arrival means board sign-off cadence matters.
4. **Is there a COLI-follow-through campaign that Minderoo is seeding?** If yes, The Three Circles should explicitly position as its community-evidence layer.
...
- Shows the scoring pipeline health in real time
- Shows what's changed since Lucy last opened the envelope

**The combo is the artefact.** The printed envelope is proof of discipline; the live dashboard is proof of operation. Together they say: *we are already doing this. We are asking for three years of what is already running to be visible at national scale.*

Minderoo's own COLI launch playbook = physical report + national event + ongoing media. Our envelope + dashboard mirrors that playbook exactly.
...
- Anchors confirmed: 3 → 5
- Community-controlled orgs contactable: 0 → 2,177
- Evidence records: 1,155 interventions + now 7,285 enriched ORIC corporations

Caption: *"This is the rate of change over two weeks. Three years of Minderoo support compounds this curve."*

---

## Three immediate shifts to make in envelope drafts

1. **Open every artefact with a Minderoo-native sentence.** Rewrite every opening paragraph to cite COLI, "partner-led", "scaling deep", or "endurance and accountability" in the first line.
2. **Drop the product names from the cover copy.** ALMA, CivicGraph, Empathy Ledger stay in the appendix. Cover copy refers to functions: "national evidence backbone", "consented story corpus".
3. **Lead the budget with partnership infrastructure (36%), not editorial (28%).** The Minderoo-facing budget cut makes Circle Two the biggest because Minderoo's 2030 Strategy pays for partnership. ACT's internal view by Circle is in the appendix.

---

*Next: apply these three shifts to the executive summary, cover letter, and canonical pitch doc. Then run the envelope print proof.*
