...
date: 2026-04-20
sources:
  - Minderoo Communities Focus Area (minderoo.org/building-communities)
  - COLI August 2025 media release (minderoo.org/media)
  - Minderoo 2030 Strategy
...
## The mapping that writes the pitch for us

### Minderoo's 5 Outcomes × The Three Circles

| Minderoo outcome | The Three Circles delivers |
|---|---|
...
*"The Three Circles asks for $2.9M over three years. That is **0.004% of the single-year $22.3B late-intervention cost**. One tenth of one percent of one year of the problem, for three years of the upstream work that proves itself against it."*

This is a visualisation (see below) and a sentence.

---

## Where the Three Circles was already doing Minderoo's strategy (before we knew they were)

Minderoo's approach says: *"emphasises the power of local knowledge and lived experience in fostering sustainable change, recognising that the environments surrounding our children significantly influence their development."*

**Everything The Three Circles has built is this sentence:**
- **Local knowledge** = the anchor communities, the Empathy Ledger v2 story corpus
- **Lived experience** = Shayle McKellar completed HSC in custody; Benji; Jay; Laquisha; the 16 named young voices
- **Sustainable change** = multi-year anchor hold, not one-off grants
- **The environments surrounding our children** = Country, Elders-in-Council, family structures, the Kimberley, Minjerribah, Mparntwe
- **Significantly influence their development** = our data shows it. 95% diversion (Oonchiumpa). 72% school re-engagement. 97.6% less cost than detention.

The Three Circles didn't pivot to Minderoo's strategy. **It started there.** The envelope's job is to show Lucy that.

---

## Visualisations for the envelope + dashboard

### 1. The $22.3B ratio bar
Single horizontal bar, sized to represent $22.3B. A thin slice carved out of it labelled "$2.9M / 3 yrs = 0.004%". Caption: *"One tenth of one percent of one year, for three years of the upstream answer."*

Live on dashboard. Printed on cover page.

### 2. The NT $2,808 anchor
A per-capita bar chart: NT ($2,808) · Qld ($921) · SA ($1,011). NT highlighted in ochre. Oonchiumpa pinned on the NT bar. Caption: *"Every dollar spent on Oonchiumpa is upstream of the $2,808 NT per-person spend."*

### 3. The 47% trajectory
A line chart: $15.2B (2019) → $22.3B (2025) → [projection without intervention] → [projection with the Three Circles]. The "with" line bends downward from 2026. Caption: *"The Three Circles is what bends the curve."*

### 4. The 5-Outcomes crosswalk
A 5×3 grid: Minderoo's five outcomes × Three Circles (One, Two, Three). Each cell lights up with the specific anchor activity that delivers on that outcome. Readable in 30 seconds. Lucy can show it to her board.

### 5. The Nest × Three Circles matrix
Minderoo's six Nest wellbeing areas across the top; Three Circles activities down the side. Each cell either filled (currently delivering) or dashed (Year 2-3 target).

### 6. Growth delta sparklines
Four small sparklines over the last 14 days:
- Stories flowing: 6 → 25
- Named young voices: 9 → 16
- ACCOs with contact: 0 → 2,177
- Anchors with active approval: 3 → 5

Caption: *"This is the rate of change over two weeks. Three years of Minderoo support compounds this curve."*

### 7. The anchor constellation (upgrade the current map)
Current Leaflet map shows 13 pinpoints. Upgrade:
- Size of pin = corp_size (Large / Medium / Small)
- Colour = confirmation status
- Dashed arcs between anchors = reciprocal Brave Ones exchanges
- Orange halo = confirmed anchor with story flowing
- Hover reveals: 2024 income, FTE count, ORIC ICN, most recent story title

### 8. The Three-Year Shape
A timeline grid: 12 quarters × 3 Circles. Each quarter shows what ships. Year 3 Q4 shows the documentary + national book + launch event. Lucy can see exactly what the $2.9M produces and when.
...
## Three immediate implementation moves

1. **Replace the current dashboard sub-header** "A private view for Minderoo Foundation" with: *"Upstream of the $22.3B · the community-led answer to Minderoo's 2025 Cost of Late Intervention report."*

2. **Add the $22.3B ratio bar to the dashboard above the hero stats.** Single horizontal visual. It's the most important chart we can put on the page.

3. **Rewrite the "What young people get" section opening** to lead with: *"Minderoo's Communities focus area names five outcomes. The Brave Ones practice delivers all five."* Then the 5-outcomes table.

---

## What this ALSO unlocks

Because Minderoo's Communities focus area is led by Thrive by Five (early years 0–5) and The Three Circles sits in youth justice (0–24 but mostly 10–24), **this envelope is also Lucy's bridge pitch**. It connects her Youth Justice portfolio to her Early Years portfolio via the COLI trajectory argument. One pitch = two strategic alignments for her internally.

That's why Lucy is the right home. And why the envelope should explicitly name:

*"This pitch aligns with Minderoo's Communities focus area across both the Valuing the Early Years body of work (the trajectory argument) and the Place-based Engagement body of work (the anchor methodology). Lucy Stronach's portfolio is both."*
