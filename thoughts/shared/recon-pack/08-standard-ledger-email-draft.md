...
**To:** Vanessa / Standard Ledger team
**From:** Ben
**Subject:** ACT books — Oct–Mar clean-up done, ready for you (a few decisions inside)
...
- Was the Q2 BAS lodged with that GST credit? If so — since $13,142 exceeds the $12,500 "fix on a later BAS" limit — I think we need to **revise the original BAS**. Your call on the mechanism.
...
*Draft prepared 2026-05-29. Figures from the MASTER pack (`2026-05-29-standard-ledger-pack-MASTER.md`). Confirm the GST/BAS path with SL — ATO debit-error limit is $12,500 for turnover under $20M. Do not send until Ben has reviewed; check the recipient name (Vanessa) and whether the Shareholders Agreement / Pty Xero access wording needs adding.*
