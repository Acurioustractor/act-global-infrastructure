...
date: 2026-04-24
sources_queried:
  - thoughts/shared/plans/act-entity-migration-checklist-2026-06-30.md (canonical checklist)
  - xero_invoices status!=VOIDED outstanding>0 (sole-trader receivables)
  - xero_invoices.contact_id matched against checklist named contacts (Snow, Centrecorp, Rotary, etc.)
  - wiki/decisions/act-core-facts.md (canonical entity names)
  - thoughts/shared/{plans,drafts,handoffs}/** for cutover-related work in flight
---
...
### Weeks 6-8
14. Subscription audit output (use existing `subscription_patterns` table).
