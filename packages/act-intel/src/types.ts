...
export interface DailyBriefingResult {
  ...
  active_projects: Array<{ code: string; status: string; activity_count: number }>
...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// Project Config (from projects table)
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
export interface CashflowResult {
  ...
  scenarios: Array<{ name: string; description: string; adjustments: unknown }>
}
...
export interface RevenueScoreboardResult {
  ...
  pipeline: {
    byStatus: Record<string, { count: number; totalValue: number; weightedValue: number }>
    totalValue: number
  ...
  receivables: {
    total: number
    items: Array<{ name: string; funder: string; amount: number; notes: string }>
  }
  scenarios: Array<{ name: string; description: string; targets: Record<string, number> }>
  projects: {
    active: number
    total: number
  }
